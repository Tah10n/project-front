create table player (id bigint not null, banned bit not null, birthday datetime not null, level integer not null, name varchar(12) not null, profession integer not null, race integer not null, title varchar(30) not null, primary key (id))
